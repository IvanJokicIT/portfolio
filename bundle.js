...
/*--------------------------------------------------------------------------------
  LOADING DATA
--------------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/IvanJokicIT', startPage)
...
function footerComponent () {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/IvanJokicIT">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
      <a href="mailto:ivan.jokic@gmail.com ">
